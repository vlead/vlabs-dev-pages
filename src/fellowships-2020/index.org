#+title:  Announcement for 6-month IIIT Fellowship
...
* Location  and Work Schedule
  ...
  *Remote* - working on the Fellows own Laptop
...
* Requirements
  ...
  sets of skills: Web/App application development, systems
  ...
  10. Quick self-learner, proactive team player and an
      effective communicator.

  11. Personal Laptop to work. 	

			
  In addition, these common skills are expected:

  1.  Documentation

  2.  Ability to learn independently, curiosity etc.
