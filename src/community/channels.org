...
** Open Slack Channel
*** Open Slack Channel
    Use [[https://vleadworkspace.slack.com/messages/CAPGMJT4N/][vlead-open-slack-channel]] for collaboration and communication
    on virtual labs project/role specific activities.
** Mailing Lists
*** Google Groups
