...
* Definitions and Pre-requisites
  Virtual Labs hosting process will require certain prerequisites
...
** Repository Owner
   ...
   authority for a [[https://github.com/virtual-labs/engineers-forum/issues/new/choose]['hosting request]]'. The owner should ensure
...
** Requester 
   A repository owner or a developer who raises a '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]'.
** Tags
   ...
   All Virtual Labs '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' should specify a tag.
...
** Build Process
   ...
   and functioning as desired before raising a'[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
   request]]'.
...
** On-Boarding process of hosting unit 
  ...
  6. Software environment specification including:
     ...
     a. Host operating system with minimum compatible
     version

     b. Any additional software packages with minimum
     compatile versions
...
** Hosting Process of hosting unit
   ...
   A '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' will be tied to this information.
   This issue will be a single source of truth for that
   hosting request.  All communication related to the
   hosting will be recorded on the raised '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]'.

*** *Lifecycle of a Hosting Request*
    
    The'[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' will go through the following
    lifecycle:

    1.  Requester will raise a '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' issue by duly
    ...
    2.  If requester is not the repository owner, the
        ...
        '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' issue.

    3.  The hosting team will honour the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]'
       only on receiving the approval from repository owner
       else will label the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' issue as *Not
       Approved*
   
    4.  On a successful hosting, the hosting team will add
       the link of the newly hosted content to the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
    ...
    8.  An issue with *Reopened* label will by default host
       ...
       '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]' initially. However, if the
       requester has specifically requested a revert, the
       previously hosted image will be restored and issue
       will be labelled as *Reverted*.
    ...
    10. Requester will be responsible for closing a '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
        request]]' issue by changing the issue status from
        Open to Closed when the issue is labelled as
        *Hosted* or *Reopened* or *Reverted* or *Not
        Approved*.
...
*** *Labels & Status of a Hosting Request* 
    ...
    *Hosted* : This label indicates that the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
    request]]' has been successful and the hosted url has been
    shared in the [[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]] issue. This label is used
    only by the hosting team.
   
    *Failed* : This label indicates that the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
    request]]' has not been successful. This label is used
    only by the hosting team.
    ...
    *Not Approved* : This label indicates that the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
    request ]]' issue raised by the requester was not approved
    by the Repository Owner.  This label is used only by the
    hosting team.
    
    *Reverted* : This label indicates that the '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting
    request]]' has been successfully revert to the previous
    hosted image. This label is used only by the hosting
    team.
    
    Apart from the above mentioned labels a '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]'
    issue can either be in a closed or open status as
    provided by GitHub. 

    *Open* : This status indicates that a new '[[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]'
    ...
    *Closed* : This status indicates that a [[https://github.com/virtual-labs/engineers-forum/issues/new/choose][hosting request]]
...
#+NAME:   fig:flowchart
 ...
 /[[https://docs.google.com/drawings/d/1JfrZerBuMvTBFFfbhiMKKmePMNJ0GsbfTnsnvRbCLZw/edit][edit image]]/
