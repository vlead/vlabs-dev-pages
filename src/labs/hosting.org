...
#+NAME: tbl-hosting-responsibilities
|-------+---------------------------------------------------------+-------------------+---+---|
| S.No. | Task                                                    | Responsibility    |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    1. | Create a tag on the sources                             |                   |   |   |
|       | of an application                                       | Application owner |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    2. | Test the application before                             | Application owner |   |   |
|       | hosting request is raised                               |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    3. | Create an hosting request                               | Application owner |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    4. | Verify the hosting request                              | Hosting Team      |   |   |
|       | details                                                 |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    5. | Label the issue *FAILED* when the request               |                   |   |   |
|       | does not meet the verification criteria                 |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    6. | Host the Application when verification                  | Hosting Team      |   |   |
|       | meets the criteria and label the issue                  |                   |   |   |
|       | *HOSTED*                                                |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    7. | Provide the url of the hosted application               | Hosting Team      |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    8. | Verification/testing of the                             | Application owner |   |   |
|       | hosted application                                      |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|    9. | Label the issue *CLOSED* when application               | Application owner |   |   |
|       | behavior meets the verification/testing                 |                   |   |   |
|       | criteria                                                |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|   10. | Label the issue *REOPENED* when application             | Application owner |   |   |
|       | behavior does not meet the verification/testing         |                   |   |   |
|       | criteria                                                |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|   11. | Request to either revert to the                         | Application owner |   |   |
|       | previous stable version or to                           |                   |   |   |
|       | re-host the application with the same                   |                   |   |   |
|       | tag as mentioned in the current                         |                   |   |   |
|       | hosting request                                         |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|   12. | Revert the application and label the issue *REVERTED*   | Hosting Team      |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
|   13. | Close the issue, that is change the label to *CLOSED*   | Application owner |   |   |
|       | when the status of issue is either *FAILED* or *HOSTED* |                   |   |   |
|       | or *REVERTED*                                           |                   |   |   |
|-------+---------------------------------------------------------+-------------------+---+---|
...
[[https://github.com/virtual-labs/lab-deployment-specification/blob/master/spec-version-2.0][here]].
