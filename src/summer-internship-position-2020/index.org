...
* Projects Listing
  ...
  *Role Requirements*
   ...
   *Project Description*
   ...
   experiments.  You will also be developing some computer science
   experiments using the same tools we build.  As a part of this
   project, you will be working with the Elm framework for web
   application development.  We are looking for developers who have
   good knowledge of computer science concepts and are capable of
   developing high quality software that can be published as an open
   source package.
