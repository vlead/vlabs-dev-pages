...
* Job Description
  ...
  looking for a competent and experienced Instruction Designer to work
  for the development of Virtual experiments. Instructional Content
  for new virtual experiments such as learning objectives, outcomes
  activities, procedures, simulated experiments, quiz and feedback
  would be developed in collaboration and association with subject
  matter experts.
  ...
  GitHub and Emacs. The instruction designer should be familiar and
...
** Role
  ...
  - Work collaboratively with faculty and colleagues to analyze
    ...
    particularly ones delivered online.
  ...
  - Write effective copy, instructional text, audio and video scripts.
    ...
    the effectiveness of the course.  Utilize eLearning development
