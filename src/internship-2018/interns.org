...
* Duration 
  The internship program is planned to run through the summer of 2017 between the tentative dates
...
* Communication
  All the interns can send an email to  =2017-summer-interns@vlabs.ac.in= for any communication with Virtual Labs
